defmodule ZyzyvaLlm.Providers.Perplexity do
  @moduledoc """
  Perplexity provider. Uses the OpenAI-compatible Sonar API. Perplexity
  models have built-in web search, useful for AI visibility checks.
  """
  ...
  def chat(messages, opts \\ []) do
    ...
    case ApiKey.resolve(:perplexity, opts) do
      nil ->
